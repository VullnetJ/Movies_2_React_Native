...
class MoviesList extends React.Component {
  ...
  async getMovies() {
    ...
    let trailer = 'https://api.themoviedb.org/3/movie/354912/videos?api_key="KEY__HERE"&language=en-US&append_to_response=credits,release_dates,videos';

    let url = BASEURL+ '?api_key=' + APIKEY + '&append_to_response=credits,release_dates,videos'; 
